...
public class GameConstants {
    ...
    // Offset estático (Fallback caso a assinatura falhe)
    public static final long BASE_OFFSET = 0xA4129C;

    // Assinatura AOB para encontrar a base de materiais/entidades dinamicamente.
    // Exemplo: 8B 0D (MOV ECX) seguido pelo endereço.
